...
import com.internousdevwork.mackeypark.dao.PurchasItemIdDAO;
 ...
 * @version 1.0
 */
public class PurchasItemIdAction extends ActionSupport{
    ...
    public String execute(){
        ...
        String result = ERROR;
        PurchasItemIdDAO dao = new PurchasItemIdDAO();
        if(dao.selectMySQL()){
